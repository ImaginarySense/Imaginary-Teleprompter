...
var themeSheet, themeStyles, lastStyleSelected, defaultStyle, openCustomStylesModal;
...
function openPromptStyles() {
    openCustomStylesModal = new bootstrap.Modal(document.getElementById("openCustomStyles"), {
        keyboard: false
    });
