...
DecoupledEditor
  .create( document.getElementById('prompter'), {
    ...
    toolbar: {
      ...
      // ClassicEditor https://ckeditor.com/docs/ckeditor5/latest/api/module_ui_panel_sticky_stickypanelview-StickyPanelView.html#member-viewportTopOffset
      // limiterElement: document.getElementById("siteTop"),
      // viewportTopOffset: toolbarTopOffset
    // },
